import 'dart:async';
import 'package:fetest/Components/custom_bottemsheet.dart';
import 'package:fetest/Global/app_color.dart';
import 'package:fetest/Utils/device_helper.dart';
import 'package:fetest/Utils/time_helper.dart';
...
class CustomField {
  ...
  static final _outlineBoder = OutlineInputBorder(
    ...
    borderSide: BorderSide(width: 1, color: AppColor.boder),
  );
  ...
  static Widget dropdownButton({
    ...
    return ButtonTheme(
      ...
      child: DropdownButtonFormField<String>(
        ...
        icon: Icon(Icons.keyboard_arrow_down_rounded, color: AppColor.grey),
        style: _textStyle,
        ...
        items:
            items.map<DropdownMenuItem<String>>((value) {
              return DropdownMenuItem<String>(
                ...
                child: Text(value["label"].toString(), style: _textStyle),
              );
            }).toList(),
        onChanged: onChanged,
        value: value,
  ...
  static Align titleForm({required String title, isRequired = false}) {
    return Align(
